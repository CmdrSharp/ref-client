...
namespace RefClient
{
  public static class RefClientStyles
  {
    ...
    public static GUIStyle RedRowStyle => _redRowStyle;
    public static GUIStyle BlueRowStyle => _blueRowStyle;
    public static GUIStyle RedHeaderStyle => _redHeaderStyle;
    public static GUIStyle BlueHeaderStyle => _blueHeaderStyle;
    public static GUIStyle PlayerLabelStyle => _playerLabelStyle;
    public static GUIStyle RedButtonStyle => _redButtonStyle;
    public static GUIStyle BlueButtonStyle => _blueButtonStyle;
    ...
    public static GUIStyle GetHeaderStyle(string teamName)
    {
      if (teamName.ToLower().Contains("red"))
        return _redHeaderStyle;

      return _blueHeaderStyle;
    }

    public static GUIStyle GetRowStyle(string teamName)
    {
      if (teamName.ToLower().Contains("red"))
        return _redRowStyle;

      return _blueRowStyle;
    }
